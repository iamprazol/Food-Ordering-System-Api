@extends('layouts.app', ['title' => __('Add Food')])

@section('content')
    @include('users.partials.header', [
        'title' => __('Hello') . ' '. auth()->user()->first_name,
        'description' => __('Here you can add food to your restaurant.'),
        'class' => 'col-lg-10'
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('Add Food') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('food.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('food_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="food_name" id="food_name" class="form-control form-control-alternative{{ $errors->has('food_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Food Name') }}" value="{{ old('food_name') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control" placeholder="{{ __('Price') }}" value="{{ old('price') }}" required autofocus>
                                </div>
